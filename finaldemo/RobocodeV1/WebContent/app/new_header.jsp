...
<% 
	String userName = SessionHelper.getTenantName(request);
	if(userName == null) {
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<% 
				if("spaceDeveloper".equals(SessionHelper.getRole(request)) || "spaceManager".equals(SessionHelper.getRole(request))) 
					{ 
				%>
				...
				%>
					...
					<ul class="dropdown-menu">
						<li><a href="ViewRobot.jsp">TeamRobots</a></li>
						<li><a href="ViewMyRobot.jsp">MyRobots</a></li>
				...
				<li class="page-scroll"><a href="logout"><img class="img-responsive" src="img/power button.png" alt="" ALIGN="RIGHT" hspace="1">Logout</a></li>
				<Table>
				<tr><td>Org :</td><td><%= SessionHelper.getOrgName(request) %></td> </tr>
				<tr><td>Tenant :</td><td><%= SessionHelper.getTenantName(request) %></td> </tr>
				<tr><td>Role :</td><td><%= SessionHelper.getRole(request) %></td> </tr>
				<tr><td>User :</td><td><%= SessionHelper.getUser(request) %></td> </tr>
				</Table> 
			</ul>
