		...
		while(retryRemaining-- > 0){
			try{
				...
				case "createUser":
					 ...
					 */
					String result = null;
					Connection c = (Connection) DriverManager.getConnection("jdbc:mysql://robocodedb.cloudapp.net:32768/form","5ryvs9z2xq0aojmn","z4o8fpvpv2sdfl75");
					...
					{
						Connection conn = (Connection) DriverManager.getConnection("jdbc:mysql://robocodedb.cloudapp.net:32768/Role","5ryvs9z2xq0aojmn","z4o8fpvpv2sdfl75");
