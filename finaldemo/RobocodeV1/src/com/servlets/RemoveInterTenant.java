...
public class RemoveInterTenant extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException
		...
		Map<String, List<String>> inter_tenant = new TreeMap<String, List<String>>(Collections.reverseOrder());
				...
				for(int j =0; j < ToTenantPermission.size(); j++){
					...
					try{
						Connection connection = DriverManager
								.getConnection("jdbc:mysql://robocodedb.cloudapp.net:32768/Role?user=5ryvs9z2xq0aojmn&password=z4o8fpvpv2sdfl75");
			...
			/*try {
				//Connection connection = DriverManager
					//	.getConnection("jdbc:mysql://robocodedb.cloudapp.net:32768/Role?user=root&password=root");
