...
/*	@Override
		...
		for (int i = 0; i < RobotRankingsInfo.length; i++) { 
			...
			try {
				Connection connection = DriverManager
						.getConnection("jdbc:mysql://robocodedb.cloudapp.net:32768/form?user=root&password=root");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try{
			Connection connection = DriverManager
					.getConnection("jdbc:mysql://robocodedb.cloudapp.net:32768/form?user=5ryvs9z2xq0aojmn&password=z4o8fpvpv2sdfl75");
