						...
						<%
							...
							//	String name = "Esther";
								try {
									...
									String selectString="SELECT userID, packageID, robotID from robot where userName = '"
											 +SessionHelper.getUser(request)+"' and  orgName = '"+SessionHelper.getOrgName(request)+"'";
									resultset = statement
