						...
						<%
							...
							//	String name = "Esther";
								try {
									...
									Connection connection = DriverManager.getConnection(connectionURL, "5ryvs9z2xq0aojmn",
											"z4o8fpvpv2sdfl75");

									Statement statement = connection.createStatement();
									// change made.
	
									//String selectString="SELECT userID, packageID, robotID from robot where tenantName = '" +SessionHelper.getTenantName(request)+"'";
									String selectString="SELECT userID, packageID, robotID from robot where tenantName = '"
											+SessionHelper.getTenantName(request)+"' and  orgName = '"+SessionHelper.getOrgName(request)+"'";
									resultset = statement
